...
const Navbar = () => {
  ...
  return (
    <div>
      <nav className="relative bg-[#6e36fd] flex items-center justify-between sm:h-10 py-10 px-4">
        <div className="flex items-center flex-1 md:absolute md:inset-y-0 md:left-0">
          <div className="flex items-center justify-between w-full md:w-auto">
            <a href="/" aria-label="Home">
              <span className="font-medium text-white hover:text-gray-900 transition duration-150 ease-in-out ml-5 text-2xl">Event Management</span>
            </a>
        ...
        <div className="hidden md:flex md:space-x-10 md:mx-auto">
          ...
          <a href="/" className="font-tight text-white transition duration-150 ease-in-out">About</a>
          <a href="/" className="font-tight text-white transition duration-150 ease-in-out">Gallery</a>
          <a href="/" className="font-tight text-white transition duration-150 ease-in-out">Events</a>
          ...
          <span className="inline-flex rounded-full shadow mr-4 relative">
            ...
            {isDropdownOpen && (
              <div className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-2 z-50">
                <a href="/login" className="block px-4 py-2 text-gray-800 hover:bg-gray-200">Event Organizer Login</a>
