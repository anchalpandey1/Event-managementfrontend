      ...
      .then((data) => {
        if (data?.data) {
          ...
          const mappedEvents = data.data.map((item) => ({ // Removed slice(0, 3) to get all events
            ...
            image: "https://media.istockphoto.com/id/978975308/vector/upcoming-events-neon-signs-vector-upcoming-events-design-template-neon-sign-light-banner-neon.jpg?s=612x612&w=0&k=20&c=VMCoJJda9L17HVkFOFB3fyDpjC4Qu2AsyYn3u4T4F4c=", // Use a real image or API URL
